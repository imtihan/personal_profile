const profileData = {
  ...
  experience: [
    {
      type: 'Industry',
      logo: 'assets/logos/companies/pinterest.svg',
    ...
    {
      type: 'Industry',
      logo: 'assets/logos/companies/mozilla.svg',
    ...
    {
      type: 'Industry',
      logo: 'assets/logos/companies/meta.svg',
    ...
    {
      type: 'Industry',
      logo: 'assets/logos/companies/wish.svg',
    ...
    {
      type: 'Research',
      logo: 'assets/logos/companies/utoronto.svg',
    ...
    {
      type: 'Industry',
      logo: 'assets/logos/companies/ibm.svg',
    ...
    {
      type: 'Industry',
      logo: 'assets/logos/companies/cisco.svg',
  ...
  techStack: [
    { name: 'Python', icon: 'assets/logos/tech/python.svg' },
    { name: 'Java', icon: 'assets/logos/tech/java.svg' },
    { name: 'C++', icon: 'assets/logos/tech/cplusplus.svg' },
    { name: 'SQL', icon: 'assets/logos/tech/sql.svg' },
    { name: 'PyTorch', icon: 'assets/logos/tech/pytorch.svg' },
    { name: 'TensorFlow', icon: 'assets/logos/tech/tensorflow.svg' },
    { name: 'JAX', icon: 'assets/logos/tech/jax.svg' },
    { name: 'scikit-learn', icon: 'assets/logos/tech/scikitlearn.svg' },
    { name: 'Transformers', icon: 'assets/logos/tech/transformers.svg' },
    { name: 'XGBoost', icon: 'assets/logos/tech/xgboost.png' },
    { name: 'Ray', icon: 'assets/logos/tech/ray.svg' },
    { name: 'Kubernetes', icon: 'assets/logos/tech/kubernetes.svg' },
    { name: 'Spark', icon: 'assets/logos/tech/spark.svg' },
    { name: 'Airflow', icon: 'assets/logos/tech/airflow.svg' },
    { name: 'LangChain', icon: 'assets/logos/tech/langchain.svg' },
    { name: 'Kafka', icon: 'assets/logos/tech/kafka.svg' },
  ],
  education: [
    {
